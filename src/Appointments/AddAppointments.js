    ...
    <div className="bg-black z-50 flex flex-col justify-center items-center fixed inset-0 bg-opacity-70">
      <AnimatePresence>
        <motion.div
          ...
          className="bg-white h-screen sm:h-auto overflow-auto  w-80 sm:w-auto my-8  sm:my-0 rounded p-5"
        >
          ...
          <div className="grid grid-cols-1 mb-2 sm:grid-cols-2 gap-5">
            <div className="border border-gray-300 p-3 rounded">
              <p className="font-semibold text-lg mb-2 text-[#102E4A]">
                Selected Patient
              </p>
              {patientDetails
                ...
                .map((patient) => (
                  <div>
                    ...
                    <div className="flex items-center">
                      ...
                      <p className="text-sm text-[#102E4A]">
                        {patient.phoneNo}
                      </p>
                      <span className="text-[#102E4A] mx-1">|</span>
