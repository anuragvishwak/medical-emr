    ...
    <div className="bg-black z-50 flex flex-col justify-center items-center fixed inset-0 bg-opacity-70">
      <AnimatePresence>
        <motion.div
          ...
          className="bg-white w-80 sm:w-auto h-screen sm:h-auto overflow-auto my-8 sm:my-0 p-5"
        >
          ...
          <div className="">
            <div className="grid grid-cols-1 xl:grid-cols-2 mb-5 gap-5">
              <div className="border border-gray-300 rounded p-3">
                <p className="font-semibold text-[#102E4A] text-xl">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5">
                  ...
                  <div className="flex flex-col">
                    <label className="text-[#715AFF] font-semibold">
                      Date of Birth
                    </label>
                    <input
                      type="date"
